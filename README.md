...
- **Free and open source**, licensed [AGPL-3.0](LICENSE). Run the public
...
[docs/README.md](docs/README.md) for a guide to what's there and where
to look first.

## License

[AGPL-3.0](LICENSE). Pear-to-Pear is free software: you can redistribute
it and/or modify it under the terms of the GNU Affero General Public
License as published by the Free Software Foundation, either version 3
of the License, or (at your option) any later version. The Affero
clause matters here specifically because this is server software: if
you run a modified version of it for others to use over a network, the
AGPL requires you to make your modified source available to them too.
